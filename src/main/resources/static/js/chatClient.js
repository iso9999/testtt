...
myApp.controller('chatCtrl',function($scope,$http, $interval){
	...
	function showHisMsg(message) {
	    $("#convList").append("<li class='sent'><img src='"+$(".sent img").attr('src')+"' alt='' /><p>" + message + "</p></li>");
	}
	
	function showMymsg(message) {
	    $("#convList").append("<li class='replies'><img src='"+$(".replies img").attr('src')+"' alt='' /><p>" + message + "</p></li>");
	}
